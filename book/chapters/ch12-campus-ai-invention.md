...
> **AI 侦探任务**：完成一次负责任的 AI 设计。先发现问题、判断是否需要 AI，再制作原型、测试错误、设计人工接管并清楚展示。
...
团队还写下成功标准。在 20 张测试卡中，大多数常见物品应得到正确建议。遇到模糊、遮挡或脏污卡片，系统可以回答“不确定”。最终分类规则以学校正式说明为准。
...
课堂评价建议关注问题定义、方案比较、测试记录、隐私保护和限制说明。不要只奖励“使用了 AI”或演示成功率。成人应负责真实设备、在线账户、素材许可和数据删除。
