...
“新的”是说这次输出不是从固定答案按钮中直接选出来。它仍会受到训练材料影响，也不代表内容一定原创、真实或合适。
...
这个活动能体验“根据条件生成新组合”。人的创作还包含生活经验、目标、情感和责任，不能把纸卡游戏当成人类创作的全部。
...
如果收到熟人发来的奇怪语音或视频，不要急着照做。遇到要求转账、提供密码或保守秘密的内容，要换一种可靠方式联系本人，并立即告诉家长或老师。
...
儿童活动默认离线完成。若使用在线生成服务，应由成人确认年龄要求、账户规则、数据用途和内容过滤设置。不要上传儿童人脸、声音、姓名或学校信息。
